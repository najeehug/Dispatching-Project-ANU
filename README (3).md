# SwiftCargo AG — Final-Mile Delivery Platform
...
2. Create a new repository called `swiftcargo`
...
2. Connect your `swiftcargo` GitHub repo
3. Settings:
...
4. Add environment variables (click **Environment**):
   ...
   FRONTEND_URL   = https://swiftcargo.vercel.app  (set after step 4)
   APP_BASE_URL   = https://swiftcargo.vercel.app  (set after step 4)
   ```
5. Click **Create Web Service** — Render will build and deploy
6. Your backend URL will be something like `https://swiftcargo-api.onrender.com`
...
2. Import your `swiftcargo` GitHub repo
3. Set **Root directory** to `frontend`
4. Add environment variables:
   ```
   VITE_API_URL      = https://swiftcargo-api.onrender.com/api
   VITE_MAPBOX_TOKEN = pk.your_token (see Step 5)
   ```
5. Click **Deploy**
6. Your frontend URL will be something like `https://swiftcargo.vercel.app`
